...
\renewcommand{\title}{%
  {\LARGE \emph{Machine learning} por Difusão em Grafos para}\\[4pt]
  {\LARGE Reconstrução 3D da Geometria Trinocular de Curvas}
}
...
\newcommand{\info}{%
  ...
  Nova Friburgo, 7 de Outubro de 2019\\[1.5cm]
